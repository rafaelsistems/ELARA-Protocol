//! Medium deployment load test example
//!
//! This example runs a load test with 100 nodes, suitable for production
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("ELARA Protocol Load Test - Medium Deployment");
    println!("=============================================\n");
