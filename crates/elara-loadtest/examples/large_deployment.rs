//! Large deployment load test example
//!
//! This example runs a load test with 1000 nodes, suitable for stress testing
//! and capacity planning in high-scale production environments.

use elara_loadtest::{LoadTestScenario, scenarios};

#[tokio::main]
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("ELARA Protocol Load Test - Large Deployment");
    println!("============================================\n");
    
    let config = scenarios::large_deployment();
